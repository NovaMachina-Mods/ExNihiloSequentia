...
public class Config {
  ...
  // Ore
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableOreOverride;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableAluminum;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableCopper;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableGold;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableIron;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableLead;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableNickel;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enablePlatinum;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableSilver;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableTin;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableUranium;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableZinc;
  // Sieve
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue flattenSieveRecipes;
  @Nonnull
  private static final ForgeConfigSpec.IntValue sieveRange;
  @Nonnull
  private static final ForgeConfigSpec.IntValue maxSieveClicks;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue netherSieveSoundsEnabled;
  // Crook
  @Nonnull
  private static final ForgeConfigSpec.IntValue maxBonusStringCount;
  @Nonnull
  private static final ForgeConfigSpec.IntValue minStringCount;
  @Nonnull
  private static final ForgeConfigSpec.IntValue secondsToCompost;
  @Nonnull
  private static final ForgeConfigSpec.IntValue secondsToFluidTransform;
  // Durability Hammer
  @Nonnull
  private static final ForgeConfigSpec.IntValue hammerWoodValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue hammerStoneValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue hammerIronValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue hammerGoldValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue hammerDiamondValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue hammerNetheriteValue;
  // Durability Crooks
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookWoodValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookStoneValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookAndesiteValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookGraniteValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookDioriteValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookGoldValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookIronValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookDiamondValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookNetheriteValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue crookBoneValue;
  // Durability Meshes
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue enableMeshDurability;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshStackSize;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshStringValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshFlintValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshIronValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshDiamondValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshNetheriteValue;
  @Nonnull
  private static final ForgeConfigSpec.IntValue meshEmeraldValue;
  // Barrel
  @Nonnull
  private static final ForgeConfigSpec.IntValue barrelMaxSolidAmount;
  @Nonnull
  private static final ForgeConfigSpec.IntValue barrelNumberOfBuckets;
  @Nonnull
  private static final ForgeConfigSpec.IntValue secondsToSpawn;
  @Nonnull
  private static final ForgeConfigSpec.IntValue rainFillAmount;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue showParticles;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue netherBarrelSoundsEnabled;
  // Infested Leaves
  @Nonnull
  private static final ForgeConfigSpec.IntValue secondsToTransformLeaves;
  @Nonnull
  private static final ForgeConfigSpec.DoubleValue spreadChance;
  // Crucible
  @Nonnull
  private static final ForgeConfigSpec.IntValue crucibleNumberOfBuckets;
  @Nonnull
  private static final ForgeConfigSpec.IntValue ticksBetweenMelts;
  @Nonnull
  private static final ForgeConfigSpec.IntValue ticksBetweenSpreadAttempt;
  @Nonnull
  private static final ForgeConfigSpec.IntValue vanillaSimulateDropCount;
  @Nonnull
  private static final ForgeConfigSpec.IntValue woodBarrelMaxTemp;
  @Nonnull
  private static final ForgeConfigSpec.IntValue woodHeatRate;
  @Nonnull
  private static final ForgeConfigSpec.BooleanValue netherCrucibleSoundsEnabled;

  static {
    //pebbleConfigs
    COMMON_BUILDER.comment("Pebble Configs").push(CATEGORY_PEBBLE);
    pebbleDamage = COMMON_BUILDER.comment(
            "How much half hearts damage a pebble should do. (Default: 0)")
        .defineInRange("pebbleDamage", 0, 0, Integer.MAX_VALUE);
    COMMON_BUILDER.pop();

    //barrelConfigs
    COMMON_BUILDER.comment("Barrel Configs").push(CATEGORY_BARREL);
    barrelNumberOfBuckets = COMMON_BUILDER.comment(
            "Number of buckets the barrel will hold (Default: 1)")
        .defineInRange("barrelNumberOfBuckets", 1, 1, Integer.MAX_VALUE);
    rainFillAmount = COMMON_BUILDER.comment(
            "How much fluid rain will fill per iteration (Default: 2)")
    ...
    netherBarrelSoundsEnabled = COMMON_BUILDER.comment(
            "Should nether barrels sound like nether wood? (Default: true)")
    ...
    secondsToFluidTransform = COMMON_BUILDER.comment(
    ...
    maxBonusStringCount = COMMON_BUILDER
        .comment(
            "Maximum additional string that a crook will drop from infested leaves in addition to the minimum string count (Default: 3)")
    ...
    crucibleNumberOfBuckets = COMMON_BUILDER.comment(
            "Number of buckets the crucible will hold (Default: 4)")
        .defineInRange("crucibleNumberOfBuckets", 4, 1, Integer.MAX_VALUE);
    netherCrucibleSoundsEnabled = COMMON_BUILDER.comment(
            "Should nether crucibles sound like nether wood? (Default: true)")
    ...
    woodHeatRate = COMMON_BUILDER
        .comment(
            "Heat rate the Wood Crucible will use regardless of heat source below (Default: 2)")
    ...
    spreadChance = COMMON_BUILDER.comment(
            "Percentage of the time that infested leaves will spread (Default: 0.3)")
    ...
    flattenSieveRecipes = COMMON_BUILDER
        .comment(
            "Sieve will get results for all mesh tiers below the one in the sieve (Default: true)")
        .define("flattenSieveRecipes", true);
    sieveRange = COMMON_BUILDER
        .comment(
            "Defines the radius that a sieve will attempt to activate other sieves (Default: 2)")
    ...
    netherSieveSoundsEnabled = COMMON_BUILDER.comment(
            "Should nether sieves sound like nether wood? (Default: true)")
    ...
    enableOreOverride = COMMON_BUILDER.comment(
            "Allows ores to be enabled or disabled by this config file. (Default: false)")
        .define("enableOreOverride", false);
    enableCopper = COMMON_BUILDER.comment(
            "Enable copper ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableCopper", true);
    enableLead = COMMON_BUILDER.comment(
            "Enable lead ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableLead", true);
    enableNickel = COMMON_BUILDER.comment(
            "Enable nickel ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableNickel", true);
    enableSilver = COMMON_BUILDER.comment(
            "Enable silver ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableSilver", true);
    enableTin = COMMON_BUILDER.comment(
            "Enable tin ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableTin", true);
    enableAluminum = COMMON_BUILDER.comment(
            "Enable aluminum ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableAluminum", true);
    enablePlatinum = COMMON_BUILDER.comment(
            "Enable platinum ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enablePlatinum", true);
    enableUranium = COMMON_BUILDER.comment(
            "Enable uranium ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableUranium", true);
    enableZinc = COMMON_BUILDER.comment(
            "Enable zinc ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableZinc", true);
    enableIron = COMMON_BUILDER.comment(
            "Enable iron ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
        .define("enableIron", true);
    enableGold = COMMON_BUILDER.comment(
            "Enable gold ore pieces, chunks and ingots if they exist. 'enableOreOverride' must be true for this to work. (Default: true)")
    ...
    crookNetheriteValue = COMMON_BUILDER.comment("Durability of Netherite Crook (Default: 8192)")
        .defineInRange("crookNetheriteValue", 8192, 1, Integer.MAX_VALUE);
    ...
    meshStringValue = COMMON_BUILDER.comment(
            "Durability of String Mesh (Only useful if enableMeshDurability is true) (Default: 59)")
        .defineInRange("meshStringValue", 59, 1, Integer.MAX_VALUE);
    meshFlintValue = COMMON_BUILDER.comment(
            "Durability of Flint Mesh (Only useful if enableMeshDurability is true) (Default: 131)")
        .defineInRange("meshFlintValue", 131, 1, Integer.MAX_VALUE);
    meshIronValue = COMMON_BUILDER.comment(
            "Durability of Iron Mesh (Only useful if enableMeshDurability is true) (Default: 250)")
        .defineInRange("meshIronValue", 250, 1, Integer.MAX_VALUE);
    meshDiamondValue = COMMON_BUILDER.comment(
            "Durability of Diamond Mesh (Only useful if enableMeshDurability is true) (Default: 1561)")
        .defineInRange("meshDiamondValue", 1561, 1, Integer.MAX_VALUE);
    meshEmeraldValue = COMMON_BUILDER.comment(
            "Durability of Emerald Mesh (Only useful if enableMeshDurability is true) (Default: 1561)")
        .defineInRange("meshEmeraldValue", 1561, 1, Integer.MAX_VALUE);
    meshNetheriteValue = COMMON_BUILDER.comment(
            "Durability of Netherite Mesh (Only useful if enableMeshDurability is true) (Default: 2031)")
  ...
  public static int getCrookWoodDurability() {
    return crookWoodValue.get();
  }

  public static int getCrookStoneDurability() {
    return crookStoneValue.get();
  }
  ...
  public static int getCrookDioriteDurability() {
    return crookDioriteValue.get();
  }

  public static int getCrookGoldDurability() {
    return crookGoldValue.get();
  }
  ...
  public static boolean getNetherSieveSoundsEnabled() {
    return netherSieveSoundsEnabled.get();
  }
  ...
  public static boolean getNetherCrucibleSoundsEnabled() {
    return netherCrucibleSoundsEnabled.get();
  }
  ...
  public static boolean getNetherBarrelSoundsEnabled() {
    return netherBarrelSoundsEnabled.get();
  }
  ...
  public static void loadConfig(@Nonnull final ForgeConfigSpec spec, @Nonnull final Path path) {
    @Nonnull final CommentedFileConfig configData = CommentedFileConfig.builder(path).sync()
