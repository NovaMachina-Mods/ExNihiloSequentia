...
public class FluidTransformRecipeSerializer extends NovaRecipeSerializer<FluidTransformRecipe> {
  ...
  @Override
  @Nonnull
  public FluidTransformRecipe fromNetwork(
  ...
  public void toNetwork(
      @Nonnull final FriendlyByteBuf buffer, @Nonnull final FluidTransformRecipe recipe) {
  ...
  @Override
  @Nonnull
  protected FluidTransformRecipe readFromJson(
    ...
    final FluidStack result =
        FluidStackUtils.jsonDeserializeFluidStack(json.get("result").getAsJsonObject());
