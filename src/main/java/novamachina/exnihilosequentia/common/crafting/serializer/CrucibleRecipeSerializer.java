...
public class CrucibleRecipeSerializer extends NovaRecipeSerializer<CrucibleRecipe> {
  ...
  @Override
  @Nonnull
  public CrucibleRecipe fromNetwork(
  ...
  public void toNetwork(
      @Nonnull final FriendlyByteBuf buffer, @Nonnull final CrucibleRecipe recipe) {
  ...
  @Override
  @Nonnull
  protected CrucibleRecipe readFromJson(
    ...
    final FluidStack fluid =
        FluidStackUtils.jsonDeserializeFluidStack(json.get("fluidResult").getAsJsonObject());
    @Nullable
    final CrucibleTypeEnum typeEnum =
        CrucibleTypeEnum.getTypeByName(json.get("crucibleType").getAsString());
