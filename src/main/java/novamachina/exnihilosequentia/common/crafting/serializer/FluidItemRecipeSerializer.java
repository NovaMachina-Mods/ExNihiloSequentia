...
public class FluidItemRecipeSerializer extends NovaRecipeSerializer<FluidItemRecipe> {
  ...
  @Override
  @Nonnull
  public FluidItemRecipe fromNetwork(@Nonnull final ResourceLocation recipeId,
  ...
  public void toNetwork(@Nonnull final FriendlyByteBuf buffer,
      @Nonnull final FluidItemRecipe recipe) {
  ...
  @Override
  @Nonnull
  protected FluidItemRecipe readFromJson(@Nonnull final ResourceLocation recipeId,
