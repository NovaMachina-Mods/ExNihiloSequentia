...
public class BlockBarrel extends BaseBlock implements ITOPInfoProvider {
  ...
  public BlockBarrel(@Nonnull final BlockBuilder builder) {
    ...
    @Override
    public void addProbeInfo(@Nonnull final ProbeMode probeMode, @Nonnull final IProbeInfo
   probeInfo,
      ...
      @Nullable final AbstractBarrelEntity barrelTile = (AbstractBarrelEntity)
   world.getBlockEntity(
      ...
      if (probeMode == ProbeMode.EXTENDED) {
        probeInfo
            .text(Component.translatable("top.barrel.mode",
