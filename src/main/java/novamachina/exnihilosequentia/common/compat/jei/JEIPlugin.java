...
public class JEIPlugin implements IModPlugin {
  ...
  @Nonnull
  private static final ResourceLocation CRUCIBLES = new ResourceLocation(
      ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, ExNihiloConstants.Blocks.CRUCIBLES);

  @Nonnull
  private static final ResourceLocation FIRED_CRUCIBLES = new ResourceLocation(
      ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, ExNihiloConstants.Blocks.FIRED_CRUCIBLE);

  @Nonnull
  @Override
  public ResourceLocation getPluginUid() {
    return new ResourceLocation(ExNihiloConstants.ModIds.JEI,
...
//    registerHammerCatalyst(ExNihiloItems.HAMMER_WARPED_FUNGUS.get(), registration);
  ...
  private void registerCookCatalyst(CrookBaseItem crook,
      @Nonnull final IRecipeCatalystRegistration registration) {
    registration.addRecipeCatalyst(new ItemStack(crook), RecipeTypes.CROOK);
  }

  private void registerHammerCatalyst(HammerBaseItem hammer,
      @Nonnull final IRecipeCatalystRegistration registration) {
  ...
  private void registerCrucibles(@Nonnull final IRecipeCatalystRegistration registration) {
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_ACACIA.get()),
        RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_BIRCH.get()),
        RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_DARK_OAK.get()),
        RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_JUNGLE.get()),
        RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_OAK.get()),
        RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_SPRUCE.get()),
        RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_FIRED.get()),
        RecipeTypes.FIRED_CRUCIBLE, RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_CRIMSON.get()),
        RecipeTypes.FIRED_CRUCIBLE, RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.CRUCIBLE_WARPED.get()),
        RecipeTypes.FIRED_CRUCIBLE, RecipeTypes.CRUCIBLE, RecipeTypes.HEAT);
  }

  private void registerBarrels(@Nonnull final IRecipeCatalystRegistration registration) {
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_ACACIA.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_BIRCH.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_DARK_OAK.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_JUNGLE.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_OAK.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_SPRUCE.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_STONE.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_CRIMSON.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.BARREL_WARPED.get()),
        RecipeTypes.FLUID_ON_TOP, RecipeTypes.FLUID_TRANSFORM, RecipeTypes.FLUID_ITEM,
        RecipeTypes.COMPOST);
  }

  private void registerSieves(@Nonnull final IRecipeCatalystRegistration registration) {
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_ACACIA.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_BIRCH.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_DARK_OAK.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_JUNGLE.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_OAK.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_SPRUCE.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_CRIMSON.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
    registration.addRecipeCatalyst(new ItemStack(ExNihiloBlocks.SIEVE_WARPED.get()),
        RecipeTypes.DRY_SIEVE, RecipeTypes.WET_SIEVE);
  }
  ...
  private void registerFiredCrucible(@Nonnull final IRecipeRegistration registration) {
    @Nonnull final List<JEICrucibleRecipe> recipes = ExNihiloRegistries.CRUCIBLE_REGISTRY.getRecipeList();
  ...
  private void registerWoodCrucible(@Nonnull final IRecipeRegistration registration) {
    @Nonnull final List<JEICrucibleRecipe> recipes = ExNihiloRegistries.CRUCIBLE_REGISTRY.getRecipeList()
        .stream().filter(recipe -> recipe.getCrucibleType() == CrucibleTypeEnum.WOOD)
