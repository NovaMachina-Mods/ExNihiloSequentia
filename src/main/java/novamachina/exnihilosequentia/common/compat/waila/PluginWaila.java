...
public class PluginWaila implements IWailaPlugin {
  ...
  public void register(@Nonnull final IRegistrar registrar) {
    registrar.registerComponentProvider(new BarrelComponentProvider(), TooltipPosition.BODY,
        BlockBarrel.class);
    registrar.registerComponentProvider(new SieveComponentProvider(), TooltipPosition.BODY,
        BlockSieve.class);
    registrar.registerComponentProvider(new InfestingLeavesComponentProvider(),
        TooltipPosition.BODY, InfestingLeavesBlock.class);
    registrar.registerComponentProvider(new CrucibleComponentProvider(), TooltipPosition.BODY,
