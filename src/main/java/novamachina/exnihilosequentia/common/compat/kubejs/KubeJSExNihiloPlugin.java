...
public class KubeJSExNihiloPlugin extends KubeJSPlugin {
  ...
  public void addRecipes(RegisterRecipeHandlersEvent event) {
    ...
    event.register(ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA + ":crook", CrookRecipeJS::new);
    ...
    event.register(ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA + ":hammer", HammerRecipeJS::new);
