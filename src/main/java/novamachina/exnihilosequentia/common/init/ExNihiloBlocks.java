...
public class ExNihiloBlocks {
  ...
  public static final RegistryObject<BaseFallingBlock> DUST = BLOCKS
      .register(ExNihiloConstants.Blocks.DUST,
  ...
  public static final RegistryObject<BaseBlock> BARREL_STONE = BLOCKS
      .register(Blocks.STONE_BARREL, () -> new StoneBarrelBlock(new BlockBuilder()
          .properties(BlockBehaviour.Properties.of(Material.STONE).strength(0.75F)
