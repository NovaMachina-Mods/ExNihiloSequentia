...
public class ExNihiloFluidTypes {
  ...
  public static final RegistryObject<FluidType> WITCH_WATER_FLUID_TYPE = FLUID_TYPES.register(
      "witch_water", () -> new WitchWaterFluidType(FluidType.Properties.create()));
  public static final RegistryObject<FluidType> SEA_WATER_FLUID_TYPE = FLUID_TYPES.register(
      "sea_water", () -> new SeaWaterFluidType(FluidType.Properties.create()));
