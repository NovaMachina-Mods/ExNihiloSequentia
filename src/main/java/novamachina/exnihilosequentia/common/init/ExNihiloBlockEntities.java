...
public class ExNihiloBlockEntities {
  ...
  private static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
      DeferredRegister.create(
          ForgeRegistries.BLOCK_ENTITY_TYPES, ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA);
  ...
  @Nonnull
  public static final RegistryObject<BlockEntityType<FiredCrucibleEntity>> FIRED_CURICLBE_ENTITY =
  ...
  @Nonnull
  public static final RegistryObject<BlockEntityType<WoodCrucibleEntity>> WOODEN_CRUCIBLE_ENTITY =
      BLOCK_ENTITIES.register(
          Blocks.CRUCIBLES,
          () ->
              BlockEntityType.Builder.of(
  ...
  @Nonnull
  public static final RegistryObject<BlockEntityType<SieveEntity>> SIEVE_ENTITY =
      BLOCK_ENTITIES.register(
          Blocks.SIEVES,
          () ->
              BlockEntityType.Builder.of(
  ...
  @Nonnull
  public static final RegistryObject<BlockEntityType<InfestingLeavesEntity>>
      INFESTING_LEAVES_ENTITY =
          BLOCK_ENTITIES.register(
              Blocks.INFESTING_LEAVES,
              () ->
                  BlockEntityType.Builder.of(
                          InfestingLeavesEntity::new, ExNihiloBlocks.INFESTING_LEAVES.get())
                      .build(null));

  @Nonnull
  public static final RegistryObject<BlockEntityType<InfestedLeavesEntity>> INFESTED_LEAVES_ENTITY =
      BLOCK_ENTITIES.register(
          Blocks.INFESTED_LEAVES,
          () ->
              BlockEntityType.Builder.of(
                      InfestedLeavesEntity::new, ExNihiloBlocks.INFESTED_LEAVES.get())
                  .build(null));

  @Nonnull
  public static final RegistryObject<BlockEntityType<? extends AbstractBarrelEntity>>
