...
public class ExNihiloRegistries {
  ...
  @Nonnull
  public static final CrucibleRegistry CRUCIBLE_REGISTRY = new CrucibleRegistry();
  @Nonnull
  public static final FluidItemTransformRegistry FLUID_BLOCK_REGISTRY = new FluidItemTransformRegistry();
  @Nonnull
