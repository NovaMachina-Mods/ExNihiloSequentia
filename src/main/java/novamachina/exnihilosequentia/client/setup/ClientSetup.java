...
public class ClientSetup {
    ...
    public static void init(final FMLClientSetupEvent event) {
        ...
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_CYAN.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_GRAY.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_GREEN.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_LIGHT_BLUE.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_LIGHT_GRAY.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_LIME.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_MAGENTA.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_ORANGE.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ExNihiloBlocks.BARREL_GLASS_PINK.get(), RenderType.translucent());
