            ...
            definition -> {
              if (definition.equals(EXNItems.CROOK_WOOD)) {
                ...
                singleTexture(
                    ...
                    .override()
                    .model(halloween)
                    .predicate(ResourceLocation.fromNamespaceAndPath(ExNihiloSequentia.MOD_ID, "holiday"), 0.10F)
                    .end()
                    .override()
                    .model(christmas)
                    .predicate(ResourceLocation.fromNamespaceAndPath(ExNihiloSequentia.MOD_ID, "holiday"), 0.12F)
                    .end();
              } else {
                singleTexture(
                    definition.getId().getPath(),
