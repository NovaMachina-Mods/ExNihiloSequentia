...
import com.novamachina.exnihilosequentia.common.block.*;
...
public class ModBlocks {
    ...
    public static final RegistryObject<BaseBlock> BARREL_WOOD = BLOCKS
        .register(Blocks.BARREL_WOOD, () -> new BlockBarrel(new BlockBuilder().harvestLevel(ToolType.AXE, 0)
            .properties(Block.Properties.create(Material.WOOD).hardnessAndResistance(0.75F).sound(SoundType.WOOD)).tileEntitySupplier(BarrelTile::new)));
