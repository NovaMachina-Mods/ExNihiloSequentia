...
public class ExNihilo implements IDefaultRegistry {
    ...
    public void registerSieve(SieveRegistry registry) {
        ...
        // Grass Seeds
        registry.addDrop(Blocks.DIRT,
            EnumResource.GRASS_SEED.getRegistryObject().get(), 0.05F, EnumMesh.STRING, false);
        ...
        for (EnumOre ore : EnumOre.values()) {
            switch (ore) {
                case IRON: {
                    ...
                    registry.addDrop(Blocks.SAND, ore.getPieceItem().get(), 0.5F, EnumMesh.DIAMOND, false);
                    break;
                }
                case GOLD: {
