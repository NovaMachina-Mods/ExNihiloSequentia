...
public class Mekanism implements IDefaultRegistry {
    ...
    public void registerSieve(SieveRegistry registry) {
        ...
        if (!EnumModdedOre.COPPER.isEnabled()) {
            registry.addMultiMeshDrop(Blocks.GRAVEL, EnumModdedOre.TIN.getPieceItem()
                .get(), null, 0.05F, 0.075F, null, false);
        ...
        if (!EnumModdedOre.OSMIUM.isEnabled()) {
            registry
                .addDrop(Blocks.GRAVEL, EnumModdedOre.OSMIUM.getPieceItem().get(), 0.05F, EnumMesh.IRON, false);
            registry.addDrop(Blocks.GRAVEL, EnumModdedOre.OSMIUM.getPieceItem()
