...
public class EXNTinkersLang extends AbstractLangGenerator {
  ...
  protected void addTranslations() {
    for (int i = 0; i < EXNTinkersBlocks.BLOCKS.getEntries().size(); i++) {
      ...
      add("block."+ EXNTinkersConstants.ModIds.EX_NIHILO_TINKERS + "." + ForgeRegistries.BLOCKS.getKey(block).getPath(), properNaming(ForgeRegistries.BLOCKS.getKey(block).getPath()));
    }
