...
public class Config {
  ...
  @Nonnull private static final Builder COMMON_BUILDER = new Builder();
  ...
  static {
    ...
    barrelNumberOfBuckets =
        COMMON_BUILDER
            .comment("Number of buckets the barrel will hold (Default: 1)")
            .defineInRange("barrelNumberOfBuckets", 1, 1, Integer.MAX_VALUE);
    rainFillAmount =
        COMMON_BUILDER
            .comment("How much fluid rain will fill per iteration (Default: 2)")
    ...
    showParticles =
        COMMON_BUILDER.comment("Should Ex Nihilo show any Patricle?").define("showParticles", true);
    netherBarrelSoundsEnabled =
        COMMON_BUILDER
            .comment("Should nether barrels sound like nether wood? (Default: true)")
    ...
    secondsToSpawn =
        COMMON_BUILDER
            .comment("Number of seconds to spawn mobs (Default: 10)")
    ...
    barrelMaxSolidAmount =
        COMMON_BUILDER
            .comment(
                "How much solids need to be in barrel before composting starts (Default: 1000)")
            .defineInRange("maxSolidAmount", 1000, 1, Integer.MAX_VALUE);
    secondsToCompost =
        COMMON_BUILDER
            .comment("Number of seconds to compost (Default: 10)")
    ...
    secondsToFluidTransform =
        COMMON_BUILDER
            .comment("Number of seconds to transform fluids (Default: 10)")
    ...
    vanillaSimulateDropCount =
        COMMON_BUILDER
            .comment(
                "Number of times the crook will \"break\" a leaf block to get drops (Default: 3)")
    ...
    ticksBetweenMelts =
        COMMON_BUILDER
            .comment("Ticks between melting operations (Default: 20)")
            .defineInRange("ticksBetweenMelts", 20, 1, Integer.MAX_VALUE);
    crucibleNumberOfBuckets =
        COMMON_BUILDER
            .comment("Number of buckets the crucible will hold (Default: 4)")
            .defineInRange("crucibleNumberOfBuckets", 4, 1, Integer.MAX_VALUE);
    netherCrucibleSoundsEnabled =
        COMMON_BUILDER
            .comment("Should nether crucibles sound like nether wood? (Default: true)")
    ...
    spreadChance =
        COMMON_BUILDER
            .comment("Percentage of the time that infested leaves will spread (Default: 0.3)")
    ...
    netherSieveSoundsEnabled =
        COMMON_BUILDER
            .comment("Should nether sieves sound like nether wood? (Default: true)")
    ...
    enableOreOverride =
        COMMON_BUILDER
            .comment("Allows ores to be enabled or disabled by this config file. (Default: false)")
    ...
    crookWoodValue =
        COMMON_BUILDER
            .comment("Durability of Wooden Crook (Default: 128)")
            .defineInRange("crookWoodValue", 128, 1, Integer.MAX_VALUE);
    crookStoneValue =
        COMMON_BUILDER
            .comment("Durability of Stone Crook (Default: 256)")
    ...
    crookDioriteValue =
        COMMON_BUILDER
            .comment("Durability of Diorite Crook (Default: 256)")
            .defineInRange("crookDioriteValue", 256, 1, Integer.MAX_VALUE);
    crookGoldValue =
        COMMON_BUILDER
            .comment("Durability of Gold Crook (Default: 32)")
    ...
    crookNetheriteValue =
        COMMON_BUILDER
            .comment("Durability of Netherite Crook (Default: 8192)")
