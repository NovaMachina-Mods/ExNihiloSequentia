...
public class RecipeTypes {
  ...
  public static final RecipeType<FluidOnTopRecipe> FLUID_ON_TOP =
      RecipeType.create(
          ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, "fluidontop", FluidOnTopRecipe.class);
  public static final RecipeType<FluidTransformRecipe> FLUID_TRANSFORM =
      RecipeType.create(
          ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA,
          "fluidtransform",
  ...
  public static final RecipeType<JEISieveRecipe> DRY_SIEVE =
      RecipeType.create(
          ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, "dry_sieve", JEISieveRecipe.class);
